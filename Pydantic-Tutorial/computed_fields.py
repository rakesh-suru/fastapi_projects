...
class Patient(BaseModel):
    ...
    def validate_emergency(cls, model):
        if model.age > 60 and 'emergency' not in model.contact_details:
            raise ValueError("Patients Older than 60 need emergency contact")
        
    @computed_field
    @property
    def bmi(self) -> float:
        val = round(self.weight/(self.height**2), 2)
        return val
...
patient_info = {"name" : "kaushik", "email" : "kaushikkonda@hdfc.com" ,"website" : "http://kaushikkonda.com", "age" : 65, "weight" : 65.5, "height" : 1.75 ,"married" : False, "allergies" : ["dust", "cold"], "contact_details" : {"website" : "kaushikkonda.com", "emergency" : "9876543210"}}
